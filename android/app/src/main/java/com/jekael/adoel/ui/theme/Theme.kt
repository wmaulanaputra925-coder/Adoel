...
// below carries Matching instead. Do not also use Sky for machine-type identity (see
// mesinTipeColor in Icons.kt), or a D408 badge next to a Normal doff action reads as related when
// they're unconnected.
